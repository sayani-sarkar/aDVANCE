...
<?php
    ...
    $sql="insert into user(name,email,age,balance) values('{$name}','{$email}','{$age}','{$balance}')";
...
?>
        ...
        <h2 class="text-center pt-4"  style="color : #48C9B0 ;">Create an account</h2>
        <br>
...
<footer class="text-center mt-5 py-2">
            <p> - <br> @project for The Sparks Foundation </p>
</footer>
